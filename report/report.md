...
![Исправление прав запуска X-соединения в виртуальной машине mininet](images/1.png){ #fig:001 width=100% height=100% }
...
![Создание простейшей топологии](images/2.png){ #fig:002 width=100% height=100% }
...
![Отображение информации их сетевых интерфейсов и IP-адресов](images/3.png){ #fig:003 width=100% height=100% }

Проверим подключение между хостами h1 и h2 с помощью команды ping с параметром -c 6 (рис. [-@fig:004]):

![Проверка подключения между хостами h1 и h2](images/4.png){ #fig:004 width=100% height=100% }

На хосте h1 добавим задержку в 100 мс к выходному интерфейсу (рис. [-@fig:005]):

![Добавление задержки в 100 мс к выходному интерфейсу на хосте h1](images/5.png){ #fig:005 width=100% height=100% }
...
![Проверка](images/6.png){ #fig:006 width=100% height=100% }
...
![Добавление задержки в 100 мс к выходному интерфейсу на хосте h2](images/7.png){ #fig:007 width=100% height=100% }
...
![Проверка](images/8.png){ #fig:008 width=100% height=100% }

Изменим задержку со 100 мс до 50 мс для отправителя h1 и для получателя h2 (рис. [-@fig:009]):

![Изменение задержки со 100 мс до 50 мс](images/9.png){ #fig:009 width=100% height=100% }
...
![Проверка](images/10.png){ #fig:010 width=100% height=100% }
...
![Восстановление конфигураций по умолчанию](images/11.png){ #fig:011 width=100% height=100% }

Добавим на узле h1 задержку в 100 мс со случайным отклонением 10 мс (рис. [-@fig:012]):

![Добавление на узле h1 задержки в 100 мс со случайным отклонением 10 мс](images/12.png){ #fig:012 width=100% height=100% }
...
![Проверка](images/13.png){ #fig:013 width=100% height=100% }

Восстановим конфигурацию интерфейса по умолчанию на узле h1 (рис. [-@fig:014]):

![Восстановление конфигурации интерфейса по умолчанию](images/14.png){ #fig:014 width=100% height=100% }
...
![Проверка](images/15.png){ #fig:015 width=100% height=100% }

Восстановим конфигурацию интерфейса по умолчанию на узле h1 (рис. [-@fig:016]):

![Восстановление конфигурации интерфейса по умолчанию](images/16.png){ #fig:016 width=100% height=100% }

Зададим нормальное распределение задержки на узле h1 в эмулируемой сети (рис. [-@fig:017]):

![Настройка нормального распределения задержки на узле h1 в эмулируемой сети](images/17.png){ #fig:017 width=100% height=100% }
...
![Проверка](images/18.png){ #fig:018 width=100% height=100% }

Восстановим конфигурацию интерфейса по умолчанию на узле h1 (рис. [-@fig:019]):

![Восстановление конфигурации интерфейса по умолчанию](images/19.png){ #fig:019 width=100% height=100% }

Завершим работу mininet в интерактивном режиме (рис. [-@fig:020]):

![Завершение работы mininet в интерактивном режиме](images/20.png){ #fig:020 width=100% height=100% }

Обновим репозитории программного обеспечения на виртуальной машине (рис. [-@fig:021]):

![Обновление репозиториев программного обеспечения на втртуальной машине](images/21.png){ #fig:021 width=100% height=100% }

Установим пакет geeqie для просмотра файлов png (рис. [-@fig:022]):

![Установка пакета geeqie](images/22.png){ #fig:022 width=100% height=100% }
...
![Создание каталога simple-delay](images/24.png){ #fig:024 width=100% height=100% }

Создадим скрипт для эксперимента lab_netem_i.py (рис. [-@fig:025]):

![Создание скрипта lab_netem_i.py для эксперимента](images/25.png){ #fig:025 width=100% height=100% }

Создадим файл ping_plot (рис. [-@fig:026]):

![Создание файла ping_plot](images/26.png){ #fig:026 width=100% height=100% }

Затем создадим скрипт для визуализации ping_plot результатов эксперимента (рис. [-@fig:027]):

![Создание скрипта ping_plot для визуализации результатов эксперимента](images/27.png){ #fig:027 width=100% height=100% }

Зададим права доступа к файлу скрипта (рис. [-@fig:028]):

![Настройка прав доступа к файлу скрипта](images/28.png){ #fig:028 width=100% height=100% }

Создадим файла Makefile (рис. [-@fig:029]):

![Создание файла Makefile](images/29.png){ #fig:029 width=100% height=100% }

Внутри файла Makefile поместим скрипт для управления процессом проведения эксперимента (рис. [-@fig:030]):

![Добавления скрипта в Makefile для управления процессом проведения эксперимента](images/30.png){ #fig:030 width=100% height=100% }

Выполним эксперимент (рис. [-@fig:031]):

![Выполнение эксперимента](images/31.png){ #fig:031 width=100% height=100% }

Просмотрим построенный в результате выполнения скриптов график (рис. [-@fig:032]):

![Просмотр графика](images/32.png){ #fig:032 width=100% height=100% }

Из файла ping.dat удалим первую строку и заново построим график (рис. [-@fig:033] - рис. [-@fig:034] ):

![Удаление первой строчки из файла ping.dat](images/33.png){ #fig:033 width=100% height=100% }

![Повторное построение графика](images/34.png){ #fig:034 width=100% height=100% }

Просмотрим заново построенный график (рис. [-@fig:035]):

![Просмотр графика](images/35.png){ #fig:035 width=100% height=100% }
...
![Разработка скрипта для вычисления на основе данных файла ping.dat минимального, среднего, максимального и стандартного отклонения времени приёма-передачи](images/36.png){ #fig:036 width=100% height=100% }

![Добавление правила запуска скрипта в Makefil](images/37.png){ #fig:037 width=100% height=100% }

![Проверка](images/38.png){ #fig:038 width=100% height=100% }
...
![Воспроизводимый эксперимент по изменению задержки](images/39.png){ #fig:039 width=100% height=100% }

![Воспроизводимый эксперимент по изменению задержки](images/40.png){ #fig:040 width=100% height=100% }

![Просмотр графика](images/41.png){ #fig:041 width=100% height=100% }

![Воспроизводимый эксперимент по изменению джиттера](images/42.png){ #fig:042 width=100% height=100% }

![Воспроизводимый эксперимент по изменению джиттера](images/43.png){ #fig:043 width=100% height=100% }

![Просмотр графика](images/44.png){ #fig:044 width=100% height=100% }

![Воспроизводимый эксперимент по изменению значения корреляции для джиттера и задержки](images/45.png){ #fig:045 width=100% height=100% }

![Воспроизводимый эксперимент по изменению значения корреляции для джиттера и задержки](images/46.png){ #fig:046 width=100% height=100% }

![Просмотр графика](images/47.png){ #fig:047 width=100% height=100% }

![Воспроизводимый эксперимент по изменению распределения времени задержки в эмулируемой глобальной сети](images/48.png){ #fig:048 width=100% height=100% }

![Воспроизводимый эксперимент по изменению распределения времени задержки в эмулируемой глобальной сети](images/49.png){ #fig:049 width=100% height=100% }

![Просмотр графика](images/50.png){ #fig:050 width=100% height=100% }
