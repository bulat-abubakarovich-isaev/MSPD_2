...
![Создание подкаталога, копирование файла с примером скрипта (описывающего стандартную простую топологию сети mininet)](images/1.png){ #fig:001 width=100% height=100% }

Изучим содержание скрипта lab_iperf3_topo.py (рис. [-@fig:002]):

![Открытие файла lab_iperf3_topo.py](images/2.png){ #fig:002 width=100% height=100% }
...
![Запуск скрипта создания топологии и дальнейший просмотр элементов](images/3.png){ #fig:003 width=100% height=100% }
...
![Внесение изменения в скрипт, позволяющего вывести на экран информацию о хосте h1 (имя, IP-адрес, MAC-адрес)](images/4.png){ #fig:004 width=100% height=100% }

Проверим корректность отработки изменённого скрипта (рис. [-@fig:005]):

![Проверка корректности отработки скрипта](images/5.png){ #fig:005 width=100% height=100% }
...
![Внесение изменения в скрипт, позволяющего вывести на экран информацию о двух хостах (имя, IP-адрес, MAC-адрес)](images/6.png){ #fig:006 width=100% height=100% }

![Проверка корректности отработки скрипта](images/7.png){ #fig:007 width=100% height=100% }
...
![Создание копии скрипта lab_iperf3_topo.py](images/8.png){ #fig:008 width=100% height=100% }
...
![Изменение скрипта lab_iperf3_topo2.py: добавление ипорта классов, изменение строки описания сети, изменение функции задания параметров виртуального хоста h1 и h2, изменение функции параметров соединения между хостом h1 и коммутатором s3](images/9.png){ #fig:009 width=100% height=100% }

Запустим на отработку скрипт lab_iperf3_topo2.py (рис. [-@fig:010]):

![Запуск скрипта lab_iperf3_topo2.py на отработку](images/10.png){ #fig:010 width=100% height=100% }
...
![Создание копии скрипта lab_iperf3_topo2.py и его дальнейшее помещение в подкаталог iperf](images/11.png){ #fig:011 width=100% height=100% }
...
![Добавление в скрипт lab_iperf3.py записи об импорте time; снятие ограничений по использованию ресурсов процессора; добавление кода, чтобы каналы между хостами и коммутатором были по 100 Мбит/с с задержкой 75 мс, без потерь](images/12.png){ #fig:012 width=100% height=100% }
...
![Описание запуска на хосте h2 сервера iPerf3, на хосте h1 запуска с задержкой в 10 секунд клиента iPerf3 с экспортом результатов в JSON-файл. Комментирование строк, отвечающих за запуск CLI-интерфейса](images/13.png){ #fig:013 width=100% height=100% }

Запустим на отработку скрипт lab_iperf3.py (рис. [-@fig:014]):

![Запуск скрипта lab_iperf3.py на отработку](images/14.png){ #fig:014 width=100% height=100% }

Построим графики из получившегося JSON-файла и создадим Makefile для проведения всего эксперимента (рис. [-@fig:015]):

![Построение графиков и создание Makefile для проведения всего эксперимента](images/15.png){ #fig:015 width=100% height=100% }

В Makefile пропишим запуск скрипта эксперимента, построение графиков и очистку каталога от результатов (рис. [-@fig:016]):

![Добавление скрипта в Makefile](images/16.png){ #fig:016 width=100% height=100% }

Проверим корректность отработки Makefile (рис. [-@fig:017]):

![Проверка корректности отработки Makefile](images/17.png){ #fig:017 width=100% height=100% }
